...
import LoginHooks from '@/components/account/google/LoginHooks';
    ...
    <>
      ...
      <Formik
        ...
        validationSchema={Yup.object().shape({
          ...
          confirmPassword: Yup.string().max(255).oneOf([Yup.ref('password'), null], 'Passwords must match').required('Required'),
        })}
          ...
          <form noValidate onSubmit={handleSubmit} {...others}>
            ...
            <Grid container spacing={matchDownSM ? 0 : 2}>
              ...
              <Grid item xs={12} sm={6}>
                <FormControl
                  fullWidth
                  error={Boolean(touched.fname && (errors.fname || errors.submit))}
              ...
              <Grid item xs={12} sm={6}>
                <FormControl
                  fullWidth
                  error={Boolean(touched.lname && (errors.lname || errors.submit))}
                  sx={{ ...theme.typography.customInput }}
                >
